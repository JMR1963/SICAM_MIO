...
//  >Import : http://localhost:8080/wsdl/IEGateMgrWS>2
// Version  : 1.0
// (06/02/2020 18:22:03 - - $Rev: 69934 $)
// ************************************************************************ //

unit IEGateMgrWS1123;
...
type
  ...
  TransactionResult2   = class;                 { "urn:EGateMgrWSIntf"[GblCplx] }
  ...
  Grupo                = class;                 { "urn:EGateMgrWSIntf"[GblCplx] }
  ...
  GrupoArray = array of Grupo;                  { "urn:EGateMgrWSIntf"[GblCplx] }
  ...
  ['{8958C337-74F6-A8D3-25EF-DB88C58189F7}']
    ...
    function  seeGroupDirection(const ungrupo: string): string; stdcall;
    function  changeGroupDirection(const ungrupo: string): string; stdcall;
    function  lstGrupos: GrupoArray; stdcall;
  end;
...
const
  defWSDL = 'http://localhost:8080/wsdl/IEGateMgrWS';
...
initialization
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(GrupoArray), 'urn:EGateMgrWSIntf', 'GrupoArray');
  ...
  RemClassRegistry.RegisterXSClass(TransactionResult2, 'urn:EGateMgrWSIntf', 'TransactionResult2');
  ...
  RemClassRegistry.RegisterXSClass(Grupo, 'urn:EGateMgrWSIntf', 'Grupo');
