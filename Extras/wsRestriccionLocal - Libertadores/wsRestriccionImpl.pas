...
uses uDMRestriccion, System.SysUtils, System.Classes, System.inifiles, System.Math, IinfoTransporte2;
      ...
      try
        ...
        begin
            ...
            begin
              ...
              ws := GetIinfoTransporte(false, urlTrans);
        ...
        log(filename,'DOC: '+ nroDoc+'|RTA: '+Result.Restriccion+'|TRANSPORTE: '+Result.Transporte+'|TIPO_PASAJERO: '+Result.TipoPasajero+'|OTROS DATOS:|'+ Ape1+'|'+ Ape2+'|'+Nom1+'|'+Nom2+'|Fecha Nac: '+formatdatetime('dd/mm/yyyy',f)+'|Nro _libreta: '+nrolibreta+ '|AutMenor: '+respMenor+ '|SitMig: '+respSitMig+'| Fecha Consulta: ' + DateTimeToStr(Now)+' | Origen Imp: '+OrigenRestri+' | VtoDNI: '+fechaVTO+' | HayTransporte (Solo Aereo): '+r);
        free;
      end;
    end;
  end;
