...
// Encoding : utf-8
// Version  : 1.0
// (27/09/2019 11:49:43 - 1.33.2.5)
// ************************************************************************ //

unit IwsRestriccionArgentina;
...
type
  ...
  published
    ...
    property TipoPasajero: WideString read FTipoPasajero write FTipoPasajero;
  end;
  ...
  ['{EB219DA4-239F-B09C-A8D6-DD790734174F}']
    function  buscarRestricciones(const Apellidos: WideString; const Nombres: WideString; const fechaNac: WideString; const nroDoc: WideString; const nrolibreta: WideString; const genero: WideString; const tipoDoc: WideString; const paisEmisorDoc: WideString; const nacionalidad: WideString): TRespuesta; stdcall;
...
uses
  uDMEntradaARGSalidaCHL;

function GetIwsRestriccion(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): IwsRestriccion;
const
 // defWSDL = 'http://172.16.192.151/cgi-bin/wsimpedimentosargentina/wsimpedimentosargentina/wsdl/IwsRestriccion';
 // defURL  = 'http://172.16.192.151/cgi-bin/wsimpedimentosargentina/wsimpedimentosargentina/soap/IwsRestriccion';
