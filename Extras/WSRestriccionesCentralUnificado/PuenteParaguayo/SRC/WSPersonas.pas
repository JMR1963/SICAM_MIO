...
// WSDL     : C:\Users\jbudrovich\Desktop\WSPersonas.xml
//  >Import : C:\Users\jbudrovich\Desktop\WSPersonas.xml>0
// Encoding : utf-8
// Codegen  : [wfForceSOAP11+, wfForceSOAP12+]
// Version  : 1.0
// (27/8/2019 14:10:14 - - $Rev: 69934 $)
// ************************************************************************ //
...
type
  ...
  ConsultarImpedimentosPRYResponse = class;     { "http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL"[Lit][GblElm] }
  Response             = class;                 { "http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL"[GblCplx] }
  DatosSalida          = class;                 { "http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL"[Lit][GblElm] }



  // ************************************************************************ //
  // XML       : ConsultarImpedimentosPRYResponse, global, <element>
  // Namespace : http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL
  ...
  // ************************************************************************ //
  // Namespace : http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL
  // soapAction: http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL/ConsultarImpedimentosPRY
  ...
  // URL       : http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx
  // ************************************************************************ //
  WebService1Soap = interface(IInvokable)
  ['{F1A58246-0F6D-9CDD-045B-C024CFAF331A}']
...
const
  defWSDL = ''; //'C:\Users\jbudrovich\Desktop\WSPersonas.xml';
  defURL  =  ''; //'http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx';
  defSvc  = 'WebService1';
...
initialization
  { WebService1Soap }
  InvRegistry.RegisterInterface(TypeInfo(WebService1Soap), 'http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL', 'utf-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(WebService1Soap), 'http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL/ConsultarImpedimentosPRY');
  ...
  RemClassRegistry.RegisterXSClass(ConsultarImpedimentosPRYResponse, 'http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL', 'ConsultarImpedimentosPRYResponse');
  RemClassRegistry.RegisterSerializeOptions(ConsultarImpedimentosPRYResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(Response, 'http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL', 'Response');
  RemClassRegistry.RegisterXSClass(DatosSalida, 'http://3.5.7.42:8890/WSMigraciones/WSPersonas.asmx?WSDL', 'DatosSalida');
