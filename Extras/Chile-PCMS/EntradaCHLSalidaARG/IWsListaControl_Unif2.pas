...
// WSDL     : http://10.170.140.7:82/cgi-bin/WsRestriccionUnificado/WsListaControlUnificado/wsdl/IWsListaControl_Unif
// Encoding : utf-8
// Version  : 1.0
// (27/09/2019 12:09:51 - 1.33.2.5)
// ************************************************************************ //
...
type
  ...
  // URL       : http://10.170.140.7:82/cgi-bin/WsRestriccionUnificado/WsListaControlUnificado/soap/IWsListaControl_Unif
  // ************************************************************************ //
  IWsListaControl_Unif = interface(IInvokable)
  ['{A790B27F-FF89-C0DC-F942-D4F1EE730D11}']
...
const
 // defWSDL = 'http://10.170.140.7:82/cgi-bin/WsRestriccionUnificado/WsListaControlUnificado/wsdl/IWsListaControl_Unif';
 // defURL  = 'http://10.170.140.7:82/cgi-bin/WsRestriccionUnificado/WsListaControlUnificado/soap/IWsListaControl_Unif';
...
begin
  Result := nil;
  defURL := DMSem.GLOBAL_WSListaControlCHL;
  if (Addr = '') then
  begin
    if UseWSDL then
      Addr := defWSDL
