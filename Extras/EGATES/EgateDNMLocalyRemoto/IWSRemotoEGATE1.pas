...
// Version  : 1.0
// (19/09/2019 16:56:31 - - $Rev: 69934 $)
// ************************************************************************ //

unit IWSRemotoEGATE1;
...
type
  ...
  IWSRemotoEGATE = interface(IInvokable)
    ...
    function fingerMatch(const paramList: string; const image: TByteDynArray)
      : Integer; stdcall;
    function faceMatch(const paramList: string; const strImgB64: string)
      : Integer; stdcall;
...
function GetIWSRemotoEGATE(UseWSDL: Boolean = System.False; Addr: string = '';
  HTTPRIO: THTTPRIO = nil): IWSRemotoEGATE;

implementation

uses System.SysUtils, uGlobal;

function GetIWSRemotoEGATE(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO)
  : IWSRemotoEGATE;
const
...
begin
  ...
  try
    ...
    THTTPRIO(RIO).HTTPWebNode.ConnectTimeout := 6000;
    THTTPRIO(RIO).HTTPWebNode.SendTimeout := 6000;
    THTTPRIO(RIO).HTTPWebNode.ReceiveTimeout := 6000;
...
InvRegistry.RegisterInterface(TypeInfo(IWSRemotoEGATE),
  'urn:WSRemotoEGATEIntf-IWSRemotoEGATE', '');
InvRegistry.RegisterDefaultSOAPAction(TypeInfo(IWSRemotoEGATE),
  'urn:WSRemotoEGATEIntf-IWSRemotoEGATE#%operationName%');
