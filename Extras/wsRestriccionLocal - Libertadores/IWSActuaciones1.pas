...
// WSDL     : http://172.16.0.31/cgi-bin/wsactuaciones/wsactuaciones/wsdl/IWSActuaciones
// Encoding : utf-8
// Version  : 1.0
// (04/01/2019 19:06:44 - 1.33.2.5)
// ************************************************************************ //
...
type
  ...
  TSituacionMig        = class;                 { "urn:WSActuacionesIntf" }
  ...
  // URL       : http://172.16.0.31/cgi-bin/wsactuaciones/wsactuaciones/soap/IWSActuaciones
  // ************************************************************************ //
  ...
  ['{56566CD8-49D4-DFBD-B69E-641145BCF4F4}']
    ...
    function  GetSituacionMigratoria(const documento: WideString): TSituacionMig; stdcall;
  end;
...
const
  //defWSDL = 'http://172.16.0.31/cgi-bin/wsactuaciones/wsactuaciones/wsdl/IWSActuaciones';
  //defURL  = 'http://172.16.0.31/cgi-bin/wsactuaciones/wsactuaciones/soap/IWSActuaciones';
...
initialization
  ...
  RemClassRegistry.RegisterXSClass(TSituacionMig, 'urn:WSActuacionesIntf', 'TSituacionMig');
