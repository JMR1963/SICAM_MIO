...
// Encoding : utf-8
// Version  : 1.0
// (13/09/2019 18:54:25 - 1.33.2.5)
// ************************************************************************ //

unit IWSValidarSemaforo2;
...
type
  ...
  published
    ...
    property TDI: WideString read FTDI write FTDI;
  ...
  ['{C2B1183B-4EEB-3102-5B85-7064BB739A50}']
    function EnviarRespuesta(const Datos: TDatosEntrada):WideString; stdcall;
...
begin
  defURL := DMSem.GLOBAL_WSValSemaforo;
  Result := nil;
  if (Addr = '') then
  begin
    if UseWSDL then
