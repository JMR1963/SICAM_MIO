...
// Version  : 1.0
// (02/09/2019 16:48:01 - 1.33.2.5)
// ************************************************************************ //

unit Ipuentechileno2;
...
type
  ...
  WriteRequestCHL      = class;                 { "urn:puentechilenoIntf" }
  WriteResponseCHL     = class;                 { "urn:puentechilenoIntf" }
  DespachosChileRequestCHL = class;             { "urn:puentechilenoIntf" }
  DespachosChileResponseCHL = class;            { "urn:puentechilenoIntf" }
  ...
  private
    FData: WideString;
    FFechaCierre: WideString;
    FFileName: WideString;
  published
    property Data: WideString read FData write FData;
    property FechaCierre: WideString read FFechaCierre write FFechaCierre;
  ...
  ['{DF3047EE-01A9-ABC1-A924-4433DF4A84B7}']
    ...
    function  RegistraViajeCHL(const request: WriteRequestCHL): WriteResponseCHL; stdcall;
    function  DespachosChileCHL(const request: DespachosChileRequestCHL): DespachosChileResponseCHL; stdcall;
  end;

function GetIpuentechileno(UseWSDL: Boolean=System.False; ip:string=''; Addr: string=''; HTTPRIO: THTTPRIO = nil): Ipuentechileno;


implementation

function GetIpuentechileno(UseWSDL: Boolean;  ip:string; Addr: string; HTTPRIO: THTTPRIO): Ipuentechileno;
const
...
begin
  ...
  begin
    if UseWSDL then
      Addr := 'http://'+ip+'/cgi-bin/puentechileno/puentechileno/wsdl/Ipuentechileno'
    else
      Addr := 'http://'+ip+'/cgi-bin/puentechileno/puentechileno/soap/Ipuentechileno';
  end;
  if HTTPRIO = nil then
...
initialization
  ...
  RemClassRegistry.RegisterXSClass(WriteRequestCHL, 'urn:puentechilenoIntf', 'WriteRequestCHL');
  RemClassRegistry.RegisterXSClass(WriteResponseCHL, 'urn:puentechilenoIntf', 'WriteResponseCHL');
  RemClassRegistry.RegisterXSClass(DespachosChileRequestCHL, 'urn:puentechilenoIntf', 'DespachosChileRequestCHL');
  RemClassRegistry.RegisterXSClass(DespachosChileResponseCHL, 'urn:puentechilenoIntf', 'DespachosChileResponseCHL');
