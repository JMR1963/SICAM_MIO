{ Invokable interface IEGateMgrWS }
...
type
  ...
  ArrayOf_tns1_Event = array of Event;
  { "http://ws.egate.sol.nec.com.ar"[GblCplx] }
  ArrayOf_tns1_TransactionError = array of TransactionError;
  { "http://ws.egate.sol.nec.com.ar"[GblCplx] }
  ArrayOf_tns1_DocumentImage = array of DocumentImage;
  { "http://ws.egate.sol.nec.com.ar"[GblCplx] }
  ...
  published
    ...
    property documentImages: ArrayOf_tns1_DocumentImage read FdocumentImages
      write FdocumentImages;
  ...
  published
    ...
    property localElegibilityFailed: Integer read FlocalElegibilityFailed
      write FlocalElegibilityFailed;
    property manualDoorOpened: Integer read FmanualDoorOpened
      write FmanualDoorOpened;
    property transactionId: string read FtransactionId write FtransactionId;
  end;
  ...
  published
    ...
    property transactionErrors: ArrayOf_tns1_TransactionError
      read FtransactionErrors write FtransactionErrors;
    property transactionId: string read FtransactionId write FtransactionId;
    property transactionResultCode: Integer read FtransactionResultCode
      write FtransactionResultCode;
    property transactionStatus: string read FtransactionStatus
  ...
  published
    ...
    property fingerprintImage: TByteDynArray read FfingerprintImage
      write FfingerprintImage;
  ...
  published
    property documentImageType: Integer read FdocumentImageType
      write FdocumentImageType;
  ...
  // URL       : http://10.100.121.78:8080/soap/IEGateMgrWS
  // ************************************************************************ //

  Grupo = class(TRemotable)
  private
    FIDGRUPO,FDESCRIPCION,FSENTIDO: string;
    FESTADO:Boolean;
  published
    property IDGRUPO: string read FIDGRUPO write FIDGRUPO;
  ...
  IEGateMgrWS = interface(IInvokable)
    ...
    function doMatch(const Transaction: Transaction; const image: TByteDynArray)
      : Integer; stdcall;
    function closeTransaction(const t: TransactionClosure)
      : TransactionResult; stdcall;
...
{ IEGateMgrWS }
InvRegistry.RegisterInterface(TypeInfo(IEGateMgrWS),
  'http://ws.egate.sol.nec.com.ar', '');
InvRegistry.RegisterDefaultSOAPAction(TypeInfo(IEGateMgrWS), '');
RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOf_tns1_Event),
  'http://ws.egate.sol.nec.com.ar', 'ArrayOf_tns1_Event');
RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOf_tns1_TransactionError),
  'http://ws.egate.sol.nec.com.ar', 'ArrayOf_tns1_TransactionError');
RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOf_tns1_DocumentImage),
  'http://ws.egate.sol.nec.com.ar', 'ArrayOf_tns1_DocumentImage');
RemClassRegistry.RegisterXSClass(Transaction,
  'http://common.egate.sol.nec.com.ar', 'Transaction');
RemClassRegistry.RegisterXSClass(PersonData,
  'http://common.egate.sol.nec.com.ar', 'PersonData');
RemClassRegistry.RegisterXSClass(TransactionClosure,
  'http://common.egate.sol.nec.com.ar', 'TransactionClosure');
RemClassRegistry.RegisterXSClass(TransactionError,
  'http://common.egate.sol.nec.com.ar', 'TransactionError');
RemClassRegistry.RegisterXSClass(Event,
  'http://common.egate.sol.nec.com.ar', 'Event');
RemClassRegistry.RegisterXSClass(TransactionResult,
  'http://common.egate.sol.nec.com.ar', 'TransactionResult');
RemClassRegistry.RegisterXSClass(BiometricData,
  'http://common.egate.sol.nec.com.ar', 'BiometricData');
RemClassRegistry.RegisterXSClass(DocumentImage,
  'http://common.egate.sol.nec.com.ar', 'DocumentImage');
RemClassRegistry.RegisterXSClass(FaceData, 'http://common.egate.sol.nec.com.ar',
  'FaceData');
